  ...
  return (
    <main className=" p-6 min-h-screen bg-[#0b1220] text-white overflow-hidden">
      ...
      <motion.section
        ...
        className="relative p-8 rounded-2xl bg-gradient-to-r from-blue-500 to-pink-500 overflow-hidden"
      >
        {/* Glow */}
        ...
        <p className="mt-3 text-white/90 max-w-2xl">
          ...
          with data-driven strategies that increase engagement and leads.
        </p>
          ...
          {[
            {
              ...
              desc: "Engaging and viral content strategy.",
            },
            {
              title: "Post Scheduling",
              desc: "Consistent posting for growth.",
            },
            {
              title: "Ad Campaigns",
              desc: "Paid ads for fast results.",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
      ...
      <section className="mt-12">
        <motion.h2
          ...
          className="text-2xl font-bold"
        >
          Benefits of Our Social Media Service
        </motion.h2>
      ...
      <motion.section
        ...
        className="mt-16 text-center p-10 rounded-2xl bg-gradient-to-r from-pink-500 to-blue-500"
      >
        ...
        <p className="mt-3 text-white/90">
          Let’s build your brand and grow your audience.
        </p>
